    ...
    public class General
    {
        ...
        public class Common : ICommon
        {
            ...
            public t GetByID<t>(string PartitionKey, string RowKey)
            {
                ...
                Hashtable Parameters = new Hashtable();
                Parameters.Add("Operation", "GetByID");
                Parameters.Add("PartitionKey", PartitionKey);
                Parameters.Add("RowKey", RowKey);
            ...
            public List<t> GetByStatus<t>(string Status)
            {
                ...
                Hashtable Parameters = new Hashtable();
                Parameters.Add("Operation", "GetByStatus");
            ...
            public List<t> GetAll<t>()
            {
                ...
                Hashtable Parameters = new Hashtable();
                Parameters.Add("Operation", "GetAll");
                return SQLServer.Query().Retrieve<t>(CommandType.StoredProcedure, _CommandText, Parameters);
            ...
            public List<t> GetList<t>()
            {
                ...
                Hashtable Parameters = new Hashtable();
                Parameters.Add("Operation", "GetList");
                return SQLServer.Query().Retrieve<t>(CommandType.StoredProcedure, _CommandText, Parameters);
            ...
            public List<t> GetHash<t>(string HashVersion = "")
            {
                ...
                Hashtable Parameters = new Hashtable();
                Parameters.Add("Operation", "GetHash" + (!string.IsNullOrEmpty(HashVersion) ? "-" + HashVersion : ""));
                return SQLServer.Query().Retrieve<t>(CommandType.StoredProcedure, _CommandText, Parameters);
            ...
            public List<t> GetByParentID<t>(Guid ParentID)
            {
                ...
                Hashtable Parameters = new Hashtable();
                Parameters.Add("Operation", "GetByParentID");
