...
namespace Niffler.Common.Trade
{
    ...
    {
        public BuyLimitOrdersTrader(StateData botState, int numberOfOrders, int entryTriggerOrderPlacementPips, int entryOffSetPips, double defaultTakeProfitPips, double finalOrderStopLossPips) 
